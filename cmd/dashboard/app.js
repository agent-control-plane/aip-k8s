...
function renderDetails() {
    ...
    detailsEl.innerHTML = `
        <div style="display:flex;justify-content:space-between;align-items:flex-start;">
            ...
            <a href="${req.status.result.url}" target="_blank" rel="noopener noreferrer" style="margin-left:0.5rem;text-decoration:none;font-size:0.9rem;">
                ...
                : auditLogs.map(log => {
                    ...
                    <div class="audit-item">
                        ...
                        ${log.spec.details && log.spec.details.url ? `
                            <a href="${log.spec.details.url}" target="_blank" rel="noopener noreferrer" style="margin-left:0.5rem;text-decoration:none;font-size:0.82rem;color:var(--accent-color);">
